...
-- @param charset string optional character set (default: alphanumeric)
...
-- @param opts table optional configuration (iterations, seed)
...
-- @param count number number of samples to generate (default: 10)
