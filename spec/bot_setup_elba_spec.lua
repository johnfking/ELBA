...
local expected_commands = {
    ...
    '/say ^spellmaxthresholds fastheals 65 byclass 1',
    '/say ^spellmaxthresholds fastheals 65 byclass 3',
    '/say ^spellmaxthresholds fastheals 65 byclass 5',
